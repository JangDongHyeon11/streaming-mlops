...
DB_CONNECTION_URL = os.getenv('DB_CONNECTION_URL', f'postgresql://spark_user:admin1234@postgres:{POSTGRES_PORT}/spark_pg_db')
...
logging.info("last_months_df: ",last_months_df)
